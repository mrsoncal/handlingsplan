  ...
  _bind() {
    ...
    this.channel.onmessage = (e) => {
      try {
        ...
        console.warn("[LiveSync] bad message", err);
      }
    };
  }
  async host() {
  ...
  function onSyncMessage(msg) {
    ...
    switch (msg.type) {
      ...
      case "timer:setDurations": {
        ...
        if (p.svar_replikk != null)
          setTypeDuration("svar_replikk", p.svar_replikk);
        break;
      }
      default:
        break;
...
return (
  <div className="container">
    <nav className="nav">
      ...
      <a className="btn ghost" href="#timer" target="talestolen-timer">
        Timer
      </a>
    ...
    <section className="card">
      ...
      <div className="muted">
        Add speakers by <span className="mono">delegatenummer</span> and choose
        speaking type. Upload the delegates CSV to enable auto lookup.
      </div>
      ...
      <div className="card" style={{ marginBottom: 12, display: "none" }}>
        ...
        {syncMode === "host" && (
          <>
            <div className="muted">
              1) Share this Offer with the joining device
            </div>
            <textarea
              className="input"
              rows={6}
            ...
            <div className="row" style={{ gap: 8, marginTop: 8 }}>
              <button type="button" className="btn" onClick={acceptAnswer}>
                Connect
              </button>
            </div>
          </>
          ...
          <>
            ...
            <div className="row" style={{ gap: 8, marginTop: 8 }}>
              <button
                type="button"
                className="btn"
                onClick={pasteOfferAndCreateAnswer}
              >
                Create Answer
              </button>
            </div>
...
function TimerFull({ state }) {
  ...
  return (
    <div className="full">
      <div className="name">
        {cur
          ? `${cur.name} ${cur.delegateNumber ? `(#${cur.delegateNumber})` : ""}`
          : ""}
      </div>
